    ...
    #Element de base :
        if event == "rules":
            ...
            print("                                           ,''`.  "
                ...
                "\n                                         :\/\/\/\:"
                "\n                                         :       :"
                "\nBienvenue dans le jeu de \033[1mTamagochi\033[0m !      `.___,' ")
            ...
            print("Vous pouvez faire les actions suivantes :"
                  "\n \033[1mManger, Dormir, Se laver, Jouer, Étudier, Faire du sport, Travailler\033[0m en fonction de l'état de votre créature.")
            ...
            print("Chaque action que vous faites augmente les étapes de la vie de votre créature."
                  "\n Lorsque les étapes atteignent 8, votre créature évolue et passe à l'état suivant !")
            print("-----------------------------------------------------------------------------------------------------------------------------------------------------------------")
            print("\033[1m\033[4mBut du jeu :\033[0m faire évoluer votre créature jusqu'à l'état de \033[1mVieux\033[0m en prenant soin d'elle et en lui faisant \033[1mfaire les bonnes actions au bon moment\033[0m !")
        
    #Élément porté sur des actions de la créature :
        elif event == "sleep":
            ...
            print(f"{subject.name} est parti dormir pour la nuit...")
            print(" ")
            print("        |\      _,,,---,,_"
                  "\nZZZzz /,`.-'`'    -.  ;-;;,_"
                  "\n     |,4-  ) )-,_. ,\ (  `'-'"
